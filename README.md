<img width="1920" height="508" alt=" " src="https://github.com/user-attachments/assets/0692108d-3eae-45f6-b0fe-d6c1b9a536e1" />
...
## Описание данных
Дафтафрейм `games.csv` содержит следующие признаки:
